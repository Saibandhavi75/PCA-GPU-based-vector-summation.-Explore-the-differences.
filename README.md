...
## Output:
### 1.Block.x=1023
![output](https://github.com/Saibandhavi75/PCA-GPU-based-vector-summation.-Explore-the-differences./blob/main/11.png?raw=true)
### 2.Block.x=1024
![output](https://github.com/Saibandhavi75/PCA-GPU-based-vector-summation.-Explore-the-differences./blob/main/12.png?raw=true)
### 3.Block.x=256
![output](https://github.com/Saibandhavi75/PCA-GPU-based-vector-summation.-Explore-the-differences./blob/main/13.png?raw=true)
## Result:
